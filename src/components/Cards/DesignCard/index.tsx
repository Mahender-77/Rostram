    ...
    <Box sx={{ display: "flex", width: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button
              ...
              sx={{
                width: "10rem",
                border: "1px solid #56C03C",
                borderBottom: "10px solid #56C03C",
                borderRadius: 5,
        ...
        >
          ...
          >
            <path
              d="M1 3.49998C65.0753 83.5964 603 -16 622.5 3.49998C642 23 551 44 551 75C551 106 603 127 622.5 146.5C642 166 673.5 3.49998 694.5 3.49998C715.5 3.49998 766 53 766 75C766 97 661.5 146.5 694.5 146.5C727.5 146.5 1439.5 255 1439.5 146.5"
              // d="M1 220C1 220 500.5 -100.5 353.5 100.5C206.5 301.5 647.5 161.5 647.5 161.5V133L761.5 19.0002C795.5 19.0002 792 31 792 49L678.314 161.5C678.314 161.5 1285 -106 1122 49C959 204 1437 161.5 1437 161.5"
              stroke="#3FC0F0"
              strokeWidth="10"
            />
          ...
          >
            ...
            >
              ...
              >
                We take your brand's vision to develop your e-commerce store on
                a platform of your choice so that you can enjoy all the
                benefits.
              </Typography>
              <Button
                variant="outlined"
                sx={{
                  ...
                  borderBottom: "10px solid #3FC0F0",
                  borderRadius: 5,
                  backgroundColor: "var(--whiteText)",
                  color: "#3FC0F0",
                  textTransform: "capitalize",
        ...
        >
          ...
          >
            <path
              d="M0.5 196.499C110.5 240 458 226.5 476 196.499C494 166.499 478 167.499 497 148.499C516 129.499 566.5 165.499 602.5 148.499C638.5 131.5 617 109.499 638.5 87.9994C660 66.4994 800 95 817.5 77.5C835 60 834 0.999939 865.5 0.999939C897 0.999939 1333.5 47.5 1439 10.0001"
              // d="M1 220C1 220 500.5 -100.5 353.5 100.5C206.5 301.5 647.5 161.5 647.5 161.5V133L761.5 19.0002C795.5 19.0002 792 31 792 49L678.314 161.5C678.314 161.5 1285 -106 1122 49C959 204 1437 161.5 1437 161.5"
              stroke="#FFC400"
              strokeWidth="10"
            />
          ...
          >
            ...
            >
              ...
              >
                We ensure your product reaches the right audience with seamless
                deployment, performance optimizations, and continuous support.
              </Typography>
              <Button
                variant="outlined"
                sx={{
                  ...
                  borderBottom: "10px solid var(--blackButton)",
                  borderRadius: 5,
                  backgroundColor: "var(--whiteText)",
                  color: "var(--blackButton)",
                  textTransform: "capitalize",
